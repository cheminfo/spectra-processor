...
import type { GetAutocorrelationChartOptions } from './jsgraph/getAutocorrelationChart.ts';
import { getAutocorrelationChart } from './jsgraph/getAutocorrelationChart.ts';
import type { GetBoxPlotChartOptions } from './jsgraph/getBoxPlotChart.ts';
import { getBoxPlotChart } from './jsgraph/getBoxPlotChart.ts';
import type { GetChartOptions } from './jsgraph/getChart.ts';
import { getChart } from './jsgraph/getChart.ts';
import type { NormalizationFilter } from './jsgraph/getNormalizationAnnotations.ts';
import { getNormalizationAnnotations } from './jsgraph/getNormalizationAnnotations.ts';
import type { GetNormalizedChartOptions } from './jsgraph/getNormalizedChart.ts';
import { getNormalizedChart } from './jsgraph/getNormalizedChart.ts';
import { getPostProcessedChart } from './jsgraph/getPostProcessedChart.ts';
import type { GetTrackAnnotationOptions } from './jsgraph/getTrackAnnotation.ts';
import { getTrackAnnotation } from './jsgraph/getTrackAnnotation.ts';
import type { GetCategoriesStatsOptions } from './metadata/getCategoriesStats.ts';
import { getCategoriesStats } from './metadata/getCategoriesStats.ts';
import type { GetClassLabelsOptions } from './metadata/getClassLabels.ts';
import { getClassLabels } from './metadata/getClassLabels.ts';
import type { GetClassesOptions } from './metadata/getClasses.ts';
import { getClasses } from './metadata/getClasses.ts';
import type { GetMetadataOptions } from './metadata/getMetadata.ts';
import { getMetadata } from './metadata/getMetadata.ts';
import parseJcamp from './parser/parseJcamp.ts';
import parseMatrix from './parser/parseMatrix.ts';
import type { ParseTextOptions } from './parser/parseText.ts';
import parseText from './parser/parseText.ts';
import type { AutocorrelationResult } from './spectra/getAutocorrelation.ts';
import { getAutocorrelation } from './spectra/getAutocorrelation.ts';
import { getBoxPlotData } from './spectra/getBoxPlotData.ts';
import { getMeanData } from './spectra/getMeanData.ts';
import type {
  GetNormalizedDataOptions,
  NormalizedDataResult,
} from './spectra/getNormalizedData.ts';
import { getNormalizedData } from './spectra/getNormalizedData.ts';
import type { GetNormalizedTextOptions } from './spectra/getNormalizedText.ts';
import { getNormalizedText } from './spectra/getNormalizedText.ts';
import type { GetPostProcessedDataOptions } from './spectra/getPostProcessedData.ts';
import { getPostProcessedData } from './spectra/getPostProcessedData.ts';
import type { GetPostProcessedTextOptions } from './spectra/getPostProcessedText.ts';
import { getPostProcessedText } from './spectra/getPostProcessedText.ts';
import type { AxisBoundary, MemoryStats } from './spectrum/Spectrum.ts';
import { Spectrum } from './spectrum/Spectrum.ts';
