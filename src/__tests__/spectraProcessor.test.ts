...
test('getPostProcesseddData undefined method, relative', () => {
  const spectraProcessor = getSimpleDataProcessor();
...
test('getPostProcesseddData minMax method, relative', () => {
  const spectraProcessor = getSimpleDataProcessor();
...
test('getPostProcessedChart minMax and relative', () => {
  const spectraProcessor = getSimpleDataProcessor();
...
test('getNormalizedData of non uniform data', () => {
...
test('getMinMaxX of non uniform data', () => {
  const spectraProcessor = getNonUniformDataProcessor();
...
test('getNormalizedMinMaxX of non uniform data', () => {
